...
function Home() {
  ...
  return (
    <main>
      ...
      <section
        id="home"
        className="relative min-h-screen bg-[#020617] text-slate-100 pt-32 pb-16 scroll-mt-24 overflow-hidden"
      >
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative z-10">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-black tracking-tight leading-[1.1] mt-3">
            ...
            >
              A{' '}
              <span className="font-bold text-blue-400">Graphic Designer & Editor</span>{' '}
              with{' '}
              <span className="font-bold text-blue-400">3+</span>{' '}
              years of experience delivering impactful, pixel-perfect visual experiences.
            </motion.p>
            ...
            >
              {[
                ...
                <div key={stat.label} className="border-l-2 border-blue-500/30 pl-4">
                  <p className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">{stat.value}</p>
                  <p className="text-slate-400 text-xs font-semibold uppercase tracking-widest mt-1">{stat.label}</p>
                </div>
              ))}
            </motion.div>
      ...
      <div id="about"   className="scroll-mt-24"><About   withTopOffset={false} /></div>
      <div id="service" className="scroll-mt-24"><Service withTopOffset={false} /></div>
      <div id="portfolio" className="scroll-mt-24"><Portfolio withTopOffset={false} /></div>
      <div id="contact" className="scroll-mt-24"><Contact withTopOffset={false} /></div>
    </main>
  );
}
