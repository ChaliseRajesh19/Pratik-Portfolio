      ...
      <button
        ...
        className={`w-full rounded-xl border ${
          isOpen
            ...
            : "border-blue-900/40"
        } bg-[#020617]/60 px-4 pt-6 pb-2 text-left focus:outline-none transition-all duration-300 cursor-pointer flex justify-between items-center backdrop-blur-md hover:border-blue-500/50 min-h-[56px]`}
      >
...
function Contact({ withTopOffset = true }) {
  ...
  const formY = useTransform(scrollYProgress, [0, 1], [80, -80]);
      ...
      <div ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
          <div className="pointer-events-none absolute inset-y-0 left-1/2 hidden lg:flex -translate-x-1/2 items-center justify-center">
            ...
            >
              <motion.div
                className="absolute h-52 w-52 rounded-full border border-indigo-300/15"
                style={{ rotate: signalRotate }}
              />
              <motion.div
          ...
          >
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-600 via-indigo-400 to-cyan-400 opacity-80" />
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent pointer-events-none" />
            <motion.div
              aria-hidden="true"
              className="absolute inset-y-0 -left-1/3 w-1/2 bg-gradient-to-r from-transparent via-cyan-300/10 to-transparent"
              animate={{ x: ["0%", "230%"] }}
              ...
              <form onSubmit={handleContact} className="grid gap-6">
                <div className="grid sm:grid-cols-2 gap-6 relative z-10">
                  <div className="relative group">
                    ...
                    <label
                      htmlFor="name"
                      className="absolute left-4 top-4 text-xs font-bold text-slate-400 uppercase tracking-widest transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-sm peer-focus:top-2 peer-focus:text-[10px] peer-focus:text-blue-400"
                    >
                      Your Name
                    </label>
                  </div>
                ...
                <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-8 z-10">
                  <p className="text-xs text-slate-400 font-medium max-w-xs leading-relaxed">
                    By submitting, you agree to receive a response related to your project
                    inquiry.
                  </p>
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="relative p-[2px] rounded-2xl bg-gradient-to-r from-blue-400 via-indigo-500 to-cyan-400 w-full sm:w-auto shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_40px_rgba(59,130,246,0.6)] transition-all duration-300"
                  >
                    <button
                      type="submit"
                      className="relative flex items-center justify-center gap-3 rounded-2xl bg-[#020617] px-8 py-4 text-sm font-black tracking-widest uppercase text-white overflow-hidden group w-full hover:bg-slate-900/60 transition-colors backdrop-blur-sm"
                    >
          ...
          <motion.div
            ...
            style={{ y: panelY, perspective: 1000 }}
          >
            <motion.div
            ...
            >
              ...
              <h3 className="text-xl font-black text-white mb-8" style={{ transform: "translateZ(30px)" }}>
                Contact Details
              </h3>
            ...
            <motion.div className="rounded-[2rem] border border-blue-500/20 bg-gradient-to-br from-blue-900/20 to-indigo-900/10 p-8 backdrop-blur-xl shadow-xl">
              <h4 className="text-[10px] uppercase tracking-[0.2em] text-blue-400 font-bold mb-6">
                Social Connect
              </h4>
